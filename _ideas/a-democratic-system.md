...
We can talk about the many details that one might want to change in the many different countries and continue to debate over some basic ones that are sometimes still not implemented, to the bewilderness of many experts.

What I want to focus on during this piece is more in the political and economical framework that make these "idiocies" possible and propose another one. Radically different from what exists today, yet extremely inspired by most of the successes of the current system.

Ideas developed here will be based on philosophical foundation and grand principles of freedom in life and from the masses, total liberty of association, radical democracy, maximal removal of the concentration of power, high level of technology and the free flow of people.
...
Under this proposed model, everything operates as a company, with current companies and local political subdivisions remaining intact. These local political subdivisions are organized into seven distinct groups, each with a designated rank:
  ...
  1. Commune/city/town (Rank 1)
  2. Communal group (Rank 2)
  3. Department (Rank 3)
  4. Lander/region (Rank 4)
  5. Countries (Rank 5)
  6. Blocks (Rank 6)
...
To address the challenges in our political systems, we propose transforming all institutions into a new kind of legal entity that operates more like a company. This restructuring aims to create a more inclusive and collaborative decision-making process that takes into account the diverse concerns of individuals and communities.
