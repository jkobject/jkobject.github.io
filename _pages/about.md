...
published: true
intro: 
  - excerpt: 'Computational Biologist and Engineer. co-Founder of PiPle, I am keen on project management and development. Highly independent, I am interested in improving Genomics & Biomedical research using Data Science and Machine Learning. I am now an Associate at the Broad Institute of MIT and Harvard.'
feature_row:
  ...
  #  btn_label: "Read More"
  #  btn_class: "btn--primary"
  - image_path: "assets/images/objectives.jpg"
...
_Every opinions and ideas mentioned in this website are solely mine and are not related to any other entity except if explained otherwise._
...
- The management of the quarterly CCLE dataset generation, which I have transformed into a full fledged pipeline and data repository used by researchers and companies across the world. I have also laid the groundwork for extracting and releasing new features and new sequencing types in order to improve our target prediction [3].
- A large functional genomics project called the AMLproject. Together with Maxim Pimkin, we have integrated hundreds of ChIP-seq, RNA-seq, together with TF knockouts, of a single cell line, to understand the mechanism of TF co-binding in the co-regulatory circuitry (CRC)[4]. This effort is now leading to multiple papers untangling the effect of gene transcription deregulation in the maintenance of the cancer state [5].

At the Broad Institute, I have been inspired by great researchers such as Bill Sellers, Stew Orkin, Jesse Engrietz, Aviv Regev, or David Liu. I have gained knowledge of human genomic sequencing, cancer biology, computational biology and Machine Learning, supplemented by an independent training at Harvard in biology.
I have gained a keen interest in papers using Deep Learning  methods to better map genotype to phenotype[6,7].
...
It nourished my passion for learning and thinking about the intricate mechanisms of our beings, from the networks of our brains to the networks of pathways in our cells.

I was lucky enough to discover my interest early. To make trips to foreign countries and to the infinite amount of knowledge I found on the web and my computer (see [blogs](/blog/) & [culture](/culture/).
