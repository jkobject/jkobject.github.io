...
big players fragmentation appliance companies don't make phones need to disrupt
the market every time

## The solutions

open source technologies big market players getting in the way (ikea) another
solution. a compay that only does that
